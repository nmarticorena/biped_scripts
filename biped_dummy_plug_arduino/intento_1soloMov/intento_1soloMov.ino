...
void setup(){
  ...
  //fase0
  fase0.duracion=1000; //milisegundos
  /*posLeftHip=105;
  posLeftKnee=112;
  posLeftAnkle=93;
  posRightHip=97;
 ...
 posLeftHip=106;
  ...
  //fase3
  Fases[3].duracion=1000;//2.5K //milisegundos
  posLeftHip=106;
  posLeftKnee=113;//112
  posLeftAnkle=93;
  posRightHip=97;
  ...
  //fase5
  Fases[5].duracion=1000;//2.5K //milisegundos
  posLeftHip=138;
  posLeftKnee=98;
  posLeftAnkle=101;
  posRightHip=103;
  ...
  //fase6
  Fases[6].duracion=1000;//2.5K? //milisegundos
  posLeftHip=138;
  posLeftKnee=101;
  posLeftAnkle=70;
  posRightHip=103; //?????????
