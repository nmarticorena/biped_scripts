...
pinMode(A2,INPUT);
  ...
  //fase2
  Fases[2].duracion=350;//500//750//1000K //milisegundos
...
//fase3
  Fases[3].duracion=750;//500 //milisegundos
  posLeftHip=92;
  posLeftKnee=123;
  posLeftAnkle=98;
  posRightHip=69;
  ...
  //fase4
  Fases[4].duracion=750;//1000 //milisegundos
  ...
  //fase5
  Fases[5].duracion=500;//750//1000 //milisegundos
  posLeftHip=138;
  posLeftKnee=74;
  posLeftAnkle=111;
  ...
  Fases[6].duracion=750;//1000 //milisegundos
  posLeftHip=137;
  posLeftKnee=94;
  posLeftAnkle=93;
  ...
  //fase7                                                 
  Fases[7].duracion=750;//100 //milisegundos
  posLeftHip=123;
  posLeftKnee=107;
  posLeftAnkle=81;
  ...
  //fase8
  Fases[8].duracion=750;//100 //milisegundos
...
void SensorFilter() {
 ...
 tiempoentrandofuncion = millis();
  ...
  else if (ejez>maxVal-2 && ejez<maxVal+2){
    contadormaximo+=1;
  }
 ...
 */
  //float lambda;
   ...
   //revisar      quitar el comente de los dos siguentes
   //Serial.print(" lambda: ");
