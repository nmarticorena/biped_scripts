...
//fase3
  ...
  //fase8
  Fases[8].duracion=2000;//2.5K? //milisegundos    
  posLeftHip=138;
  posLeftKnee=101;
  posLeftAnkle=70;
  posRightHip=103; //?????????
  posRightKnee=69;
  posRightAnkle=75;//???????????                                             // SEPRARARLAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
